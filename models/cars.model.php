...
class CarsModel extends SystemModel{
    ...
    public function editCar($id_car,$title, $model, $year, $kilometres, $price, $description, $photo, $brand_name){
       ...
       $sentencia = $this->getDb()->prepare("UPDATE autos SET titulo='$title', modelo='$model', anio=$year, kilometros=$kilometres,precio=$price,descripcion='$description',foto='$photo', id_marca_fk=$brand_name WHERE id_auto = ?"); // prepara la consulta
